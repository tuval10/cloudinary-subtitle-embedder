class SubtitleLineTest < Minitest::Test
  ...
  def setup
    @line = CloudinarySubtitlesEmbedder::SubtitleLine.new(self.class.subtitles[0])
  end
  ...
  def test_initialize_sets_display_options_if_provided
    ...
    @line = CloudinarySubtitlesEmbedder::SubtitleLine.new(self.class.subtitles[0], expected_display_options)
    assert_equal expected_display_options, @line.display_options
  end
  ...
  def test_to_s_handles_commas
    @line = CloudinarySubtitlesEmbedder::SubtitleLine.new(self.class.subtitles[2])
